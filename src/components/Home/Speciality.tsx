  ...
  return (
    <section className="space-y-9  bg-[url('/img/specialty.png')] bg-cover bg-center ">
      ...
      <div className="flex gap-6">
        <div
          className={` bg-[url('/img/banner.png')] bg-cover bg-center  w-[50%] h-[20rem] overflow-hidden flex flex-col px-8 justify-end py-6 rounded-lg text-white`}
        >
        ...
        <div
          className={`  bg-[#202020] bg-cover bg-center  w-[25%] h-[20rem] overflow-hidden flex flex-col px-8 justify-between py-8 rounded-lg text-white`}
        >
          <div>
        ...
        <div
          className={`  bg-[#00A24D] bg-cover bg-center  w-[25%] h-[20rem] overflow-hidden flex flex-col px-8 justify-between py-8 rounded-lg text-white`}
        >
          <div>
